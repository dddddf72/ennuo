<template>
  <div>
    ...
    >
      <el-table-column prop="id" label="菜单编号" width="180" align='center'>
      </el-table-column>
      <el-table-column prop="title" label="菜单名称" width="180" align='center'>
      </el-table-column>
...
export default {
  mounted() {
    this.axios({url:"/api/menulist?istree=1",
    // headers:{
